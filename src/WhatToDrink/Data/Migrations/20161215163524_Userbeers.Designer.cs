...
namespace WhatToDrink.Data.Migrations
{
    ...
    [Migration("20161215163524_Userbeers")]
    partial class Userbeers
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("WhatToDrink.Models.YourBeer", b =>
                {
                    b.Property<int>("YourBeerId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WhatToDrink.Models.YourBeer", b =>
                {
                    b.HasOne("WhatToDrink.Models.Beer", "Beer")
                        .WithMany()
                        .HasForeignKey("BeerId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("WhatToDrink.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
        }
